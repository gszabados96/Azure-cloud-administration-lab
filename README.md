...
# Actions taken:
       ...
       3, Created a Virtual Network named gszabadosVnet
        ...
        4, Removed the unused resource groups after finishing a testing.
...
# Lessons learned:
    ...
    2, I haven't deleted the unused resource, which has resulted in a "massive" billing cost (screenshot is attached)
